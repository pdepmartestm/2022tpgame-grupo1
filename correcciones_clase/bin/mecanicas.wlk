...
object moves {
	...
	method config() {
		keyboard.left().onPressDo{ izquierda.mover(player)}
		keyboard.right().onPressDo{ derecha.mover(player)}
		keyboard.up().onPressDo{ arriba.mover(player)}
		keyboard.down().onPressDo{ abajo.mover(player)}
		keyboard.a().onPressDo{ izquierda.mover(player)}
		keyboard.d().onPressDo{ derecha.mover(player)}
		keyboard.w().onPressDo{ arriba.mover(player)}
		keyboard.s().onPressDo{ abajo.mover(player)}
	}
...
class Movimientos {
	...
	method sePuedeMover(character) = return !celdasBloqueadas.contains(character.position())

	method mover(character) {
	}
...
object arriba inherits Movimientos(celdasBloqueadas = [ "0@2", "0@6", "0@11", "1@2", "1@3", "1@6", "1@9", "1@12", "1@13", "2@1", "2@2", "2@3", "2@5", "2@7", "2@12", "2@13", "3@1", "3@2", "3@5", "3@6", "3@7", "3@8", "3@11", "3@12", "3@13", "4@0", "4@1", "4@5", "4@6", "4@7", "4@8", "4@9", "4@11", "4@13", "5@0", "5@2", "5@3", "5@10", "5@11", "5@12", "6@1", "6@2", "6@4", "6@5", "6@6", "6@8", "6@9", "6@10", "6@12", "7@0", "7@1", "7@5", "7@10", "7@12", "8@0", "8@1", "8@2", "8@6", "8@7", "8@11", "8@12", "8@13", "9@0", "9@3", "9@6", "9@7", "9@8", "9@9", "9@12", "9@13", "10@1", "10@3", "10@4", "10@7", "10@8", "10@11", "11@1", "11@2", "11@3", "11@4", "11@5", "11@8", "11@9", "11@13", "12@0", "12@4", "12@9", "12@10", "12@12", "12@13", "13@1", "13@3", "13@7", "13@8", "13@10", "13@12", "13@13", "14@4", "14@7" ]) {
	...
	override method mover(character) {
